...
var G__99216 = devtools.prefs.pref(v);
v = G__99216;
continue;
} else {
return v;
...
}catch (e99180){var _e__38564__auto__ = e99180;
return false;
}})();
...
}catch (e99189){var _e__38564__auto__ = e99189;
return false;
}})();
...
}catch (e99195){var _e__38564__auto__ = e99195;
return false;
}}
}
});
...
var vec__99208 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99208,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99208,(1),null);
...
return cljs.core.some((function (p1__99211_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__99211_SHARP_);
}),template);
});
...
var temp__5737__auto__ = devtools.formatters.helpers.pref(pref_key);
if(cljs.core.truth_(temp__5737__auto__)){
var render_pref = temp__5737__auto__;
if(render_pref === true){
