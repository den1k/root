...
var temp__5737__auto__ = cljs.core.deref(devtools.hints.processed_errors);
if(cljs.core.truth_(temp__5737__auto__)){
var val = temp__5737__auto__;
return val;
} else {
...
var G__96835 = cljs.core.PersistentArrayMap.EMPTY;
var G__96836 = native_stack_trace;
var G__96837 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__96838 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__96835,G__96836,G__96837,G__96838) : cljs.stacktrace.parse_stacktrace.call(null,G__96835,G__96836,G__96837,G__96838));
});
...
var map__96842 = top_item;
var map__96842__$1 = (((((!((map__96842 == null))))?(((((map__96842.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__96842.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__96842):map__96842);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96842__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96842__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96842__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e96841){var _e = e96841;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5737__auto___96857 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5737__auto___96857)){
var seen_errors_96859 = temp__5737__auto___96857;
if(cljs.core.truth_(seen_errors_96859.has(self))){
} else {
seen_errors_96859.add(self);

var temp__5739__auto___96860 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5739__auto___96860)){
var sense_96861 = temp__5739__auto___96860;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_96861)].join(''));
} else {
}
}
} else {
...
var temp__5739__auto__ = devtools.hints.error_object_sense(error);
if(cljs.core.truth_(temp__5739__auto__)){
var sense = temp__5739__auto__;
