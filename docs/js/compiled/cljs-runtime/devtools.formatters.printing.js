...
var len__4789__auto___99514 = arguments.length;
var i__4790__auto___99515 = (0);
while(true){
if((i__4790__auto___99515 < len__4789__auto___99514)){
args__4795__auto__.push((arguments[i__4790__auto___99515]));

var G__99516 = (i__4790__auto___99515 + (1));
i__4790__auto___99515 = G__99516;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq99409){
var G__99410 = cljs.core.first(seq99409);
var seq99409__$1 = cljs.core.next(seq99409);
var G__99411 = cljs.core.first(seq99409__$1);
var seq99409__$2 = cljs.core.next(seq99409__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__99410,G__99411,seq99409__$2);
}));
...
var temp__5737__auto__ = cljs.core.first(cljs.core.first(group));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__99443_SHARP_){
return (!((cljs.core.meta(p1__99443_SHARP_) == null)));
})))){
...
var map__99458 = opts;
var map__99458__$1 = (((((!((map__99458 == null))))?(((((map__99458.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__99458.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__99458):map__99458);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__99458__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e99470){var _e__38564__auto__ = e99470;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e99472){var _e__38564__auto__ = e99472;
return false;
}}
})())){
...
var temp__5737__auto__ = devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(markup_db,new cljs.core.Keyword(null,"atomic","atomic",-120459460),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([obj], 0));
if(cljs.core.truth_(temp__5737__auto__)){
var atomic_markup = temp__5737__auto__;
...
var _STAR_current_state_STAR__orig_val__99480 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__99481 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__99481);

try{var map__99482 = opts;
var map__99482__$1 = (((((!((map__99482 == null))))?(((((map__99482.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__99482.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__99482):map__99482);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__99482__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__99480);
}});
...
var temp__5737__auto___99594 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5737__auto___99594)){
var managed_print_level_99595 = temp__5737__auto___99594;
var _STAR_print_level_STAR__orig_val__99493_99596 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__99494_99597 = managed_print_level_99595;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__99494_99597);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__99488_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__99488_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__99493_99596);
}} else {
job_fn();
}
