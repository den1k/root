...
var digit_103569 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_103570__$1 = (vlq >>> (5));
while(true){
if((vlq_103570__$1 > (0))){
var digit_103572__$1 = (digit_103569 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_103572__$1));

var G__103573 = (vlq_103570__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__103574 = (vlq_103570__$1 >>> (5));
digit_103569 = G__103573;
vlq_103570__$1 = G__103574;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_103569));
}
break;
}
...
var G__103577 = i__$1;
var G__103578 = result__$1;
var G__103579 = shift__$1;
i = G__103577;
result = G__103578;
shift = G__103579;
continue;
