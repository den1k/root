...
var temp__5737__auto__ = (function (){var temp__5737__auto__ = ((devtools.munging.get_global_scope.cljs$core$IFn$_invoke$arity$0 ? devtools.munging.get_global_scope.cljs$core$IFn$_invoke$arity$0() : devtools.munging.get_global_scope.call(null))["cljs"]);
if(cljs.core.truth_(temp__5737__auto__)){
var o98968 = temp__5737__auto__;
var temp__5737__auto____$1 = (o98968["core"]);
if(cljs.core.truth_(temp__5737__auto____$1)){
var o98969 = temp__5737__auto____$1;
return (o98969["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
if(cljs.core.truth_(temp__5737__auto__)){
var js_reserved_fn = temp__5737__auto__;
...
var o__38557__auto__ = f;
return (o__38557__auto__["toString"]).call(o__38557__auto__);
} else {
return "";
}
}catch (e98970){var _ = e98970;
return "";
}});
...
try{var o__38557__auto___99162 = t;
(o__38557__auto___99162["cljs$lang$ctorPrWriter"]).call(o__38557__auto___99162,t,writer);
}catch (e98975){var __99163 = e98975;
}
...
var char_code = (function (){var o__38557__auto__ = (new String(char$));
return (o__38557__auto__["charCodeAt"]).call(o__38557__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38557__auto__ = String;
return (o__38557__auto__["fromCharCode"]).call(o__38557__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__98977 = num_code;
switch (G__98977) {
case (1):
return (185);
...
var o__38557__auto__ = String;
return (o__38557__auto__["fromCharCode"]).call(o__38557__auto__,superscript_code);
});
/**
...
var temp__5737__auto__ = cljs.core.second(cljs.core.re_find(/function\s(.*?)\{/,fn_source));
if(cljs.core.truth_(temp__5737__auto__)){
var meat = temp__5737__auto__;
var temp__5737__auto____$1 = cljs.core.re_find(/(.*?)\((.*)\)/,meat);
if(cljs.core.truth_(temp__5737__auto____$1)){
var match = temp__5737__auto____$1;
...
}catch (e98978){var _e__38564__auto__ = e98978;
return false;
}})())){
...
var vec__98979 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__98979,(0),null);
...
var or__4185__auto__ = (function (){var temp__5737__auto__ = cljs.core.re_matches(/(.*)\$/,s);
if(cljs.core.truth_(temp__5737__auto__)){
...
var temp__5737__auto__ = (function (){var temp__5737__auto__ = ((devtools.munging.get_global_scope.cljs$core$IFn$_invoke$arity$0 ? devtools.munging.get_global_scope.cljs$core$IFn$_invoke$arity$0() : devtools.munging.get_global_scope.call(null))["goog"]);
if(cljs.core.truth_(temp__5737__auto__)){
var o98982 = temp__5737__auto__;
var temp__5737__auto____$1 = (o98982["dependencies_"]);
if(cljs.core.truth_(temp__5737__auto____$1)){
var o98983 = temp__5737__auto____$1;
return (o98983["nameToPath"]);
} else {
return null;
}
} else {
...
if(cljs.core.truth_(temp__5737__auto__)){
var goog_namespaces = temp__5737__auto__;
...
var len__4789__auto___99183 = arguments.length;
var i__4790__auto___99184 = (0);
while(true){
if((i__4790__auto___99184 < len__4789__auto___99183)){
args__4795__auto__.push((arguments[i__4790__auto___99184]));

var G__99186 = (i__4790__auto___99184 + (1));
i__4790__auto___99184 = G__99186;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__98986){
var vec__98987 = p__98986;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__98987,(0),null);
...
var G__99193 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__99194 = cljs.core.butlast(remaining_tokens);
name_tokens = G__99193;
remaining_tokens = G__99194;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq98984){
var G__98985 = cljs.core.first(seq98984);
var seq98984__$1 = cljs.core.next(seq98984);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__98985,seq98984__$1);
}));
...
var vec__98992 = cljs.core.split_with((function (p1__98991_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__98991_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__98992,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__98992,(1),null);
...
var vec__98998 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__98998,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__98998,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__99198 = cljs.core.rest(remaining_tokens);
var G__99199 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__99198;
name_tokens = G__99199;
continue;
} else {
...
var vec__99004 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99004,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99004,(1),null);
var vec__99007 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99007,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99007,(1),null);
var vec__99010 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99010,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99010,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99010,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99010,(3),null);
...
var vec__99015 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99015,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99015,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99015,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99015,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99015,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99015,(5),null);
...
var temp__5737__auto__ = devtools.munging.parse_fn_source(fn_source);
if(cljs.core.truth_(temp__5737__auto__)){
var vec__99018 = temp__5737__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99018,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99018,(1),null);
var vec__99021 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99021,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99021,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__99024 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__99024) : devtools.munging.parse_fn_info_deep.call(null,G__99024));
})()));
}
} else {
return fn_info;
...
var temp__5737__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(state,prefix);
if(cljs.core.truth_(temp__5737__auto__)){
var subscript = temp__5737__auto__;
...
var G__99214 = (arity + (1));
var G__99215 = (function (){var temp__5737__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5737__auto__)){
var arity_fn = temp__5737__auto__;
...
var temp__5737__auto__ = devtools.munging.get_fn_variadic_arity(f);
if(cljs.core.truth_(temp__5737__auto__)){
var variadic_arity = temp__5737__auto__;
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__99036){
var vec__99038 = p__99036;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99038,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99038,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__99053_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__99053_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__99054_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__99054_SHARP_);
}),sorted_infos);
...
var args__4795__auto__ = [];
var len__4789__auto___99220 = arguments.length;
var i__4790__auto___99221 = (0);
while(true){
if((i__4790__auto___99221 < len__4789__auto___99220)){
args__4795__auto__.push((arguments[i__4790__auto___99221]));

var G__99222 = (i__4790__auto___99221 + (1));
i__4790__auto___99221 = G__99222;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__99067){
var vec__99068 = p__99067;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99068,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq99058){
var G__99059 = cljs.core.first(seq99058);
var seq99058__$1 = cljs.core.next(seq99058);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__99059,seq99058__$1);
}));
...
var G__99072 = arg;
var G__99072__$1 = (((G__99072 instanceof cljs.core.Keyword))?G__99072.fqn:null);
switch (G__99072__$1) {
...
var map__99079 = options;
var map__99079__$1 = (((((!((map__99079 == null))))?(((((map__99079.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__99079.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__99079):map__99079);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__99079__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__99079__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__99079__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__99079__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__99080 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99080,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99080,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99080,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99080,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99080,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99080,(5),null);
...
var o__38557__auto__ = f;
return (o__38557__auto__["getBasis"]).call(o__38557__auto__);
});
/**
...
}catch (e99091){var _e__38564__auto__ = e99091;
...
var G__99226 = (obj[cljs.core.first(path)]);
var G__99227 = cljs.core.rest(path);
obj = G__99226;
path = G__99227;
continue;
} else {
...
var temp__5737__auto__ = cljs.core.re_matches(/(.*)\$$/,key);
if(cljs.core.truth_(temp__5737__auto__)){
var m = temp__5737__auto__;
...
var _STAR_ = (function (accum,p__99127){
var vec__99128 = p__99127;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99128,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99128,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__99134){
var vec__99137 = p__99134;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99137,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99137,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99137,(2),null);
...
var post_process = (function (p__99156){
var vec__99157 = p__99156;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99157,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99157,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__99142_SHARP_){
return (obj[cljs.core.first(p1__99142_SHARP_)]);
}),sorted_matches);
